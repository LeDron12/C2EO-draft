/*
 * Функци main в данном драфте используется для порождения тестовых конструкций.
 * Предполагается, что в дальнейшем проект будет подключаться в качестве библиотеки
 * к другому проекту, а вместо этой функции буду различные тестовые наборы данных.
 */
